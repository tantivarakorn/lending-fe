...
@Component({
  ...
  styleUrls: ['./consent-information.component.scss']
})
export class ConsentInformationComponent implements OnInit, OnDestroy {
  dataLog: DataLog;
  ...
  constructor(private service: FeaturesService) {
    this.service.setTitle('ยินยอมให้ใช้ข้อมูลส่วนตัว', 'XXXX-XXX-2325');
  }
